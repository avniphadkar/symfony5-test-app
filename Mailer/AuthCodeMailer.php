...
class AuthCodeMailer implements AuthCodeMailerInterface
{
    ...
    /**
     * Url for the testapp instance (only used for image in the HTML email template).
     *
     * @var string
     */
    private $testappUrl;
     ...
     * @param string $supportUrl  testapp support url
     * @param string $testappUrl testapp instance url
     */
    public function __construct(MailerInterface $mailer, Environment $twig, $senderEmail, $senderName, $supportUrl, $testappUrl)
    {
        $this->mailer = $mailer;
        $this->twig = $twig;

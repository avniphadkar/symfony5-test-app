...
use TestApp\Helper\PreparePagerForEntries;
...
class FeedController extends AbstractController
{
     ...
     *
     * @ParamConverter("user", class="TestApp\Entity\User", converter="username_feed_token_converter")
     *
     * @return Response
     */
    ...
    public function showTagsFeedAction(Request $request, User $user, Tag $tag, PreparePagerForEntries $preparePagerForEntries, $page)
    {
        ...
        $perPage = $user->getConfig()->getFeedLimit() ?: $this->getParameter('testapp.feed_limit');

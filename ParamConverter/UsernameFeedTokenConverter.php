...
namespace TestApp\ParamConverter;
...
use TestApp\Repository\UserRepository;
...
class UsernameFeedTokenConverter implements ParamConverterInterface
{
    ...
    public function supports(ParamConverter $configuration)
    {
        ...
        if (null !== $em && 'TestApp\Entity\User' !== $em->getClassMetadata($configuration->getClass())->getName()) {
            return false;
        }

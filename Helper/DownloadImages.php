...
class DownloadImages
{
    ...
    public function __construct(HttpClientInterface $downloadImagesClient, $baseFolder, $testappUrl, LoggerInterface $logger)
    {
        $this->client = $downloadImagesClient;
        $this->baseFolder = $baseFolder;
        $this->testappUrl = rtrim($testappUrl, '/');
        $this->logger = $logger;
    ...
    public function processSingleImage($entryId, $imagePath, $url, $relativePath = null)
    {
        ...
        $urlPath = $this->testappUrl . '/assets/images/' . $relativePath . '/' . $hashImage . '.' . $ext;

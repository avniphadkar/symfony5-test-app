 ...
 * Config.
 *
 * @ORM\Entity(repositoryClass="TestApp\Repository\ConfigRepository")
 * @ORM\Table(
 *     name="`config`",
 *     indexes={
...
class Config
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="TestApp\Entity\User", inversedBy="config")
     */
    private $user;
     ...
     *
     * @ORM\OneToMany(targetEntity="TestApp\Entity\TaggingRule", mappedBy="config", cascade={"remove"})
     * @ORM\OrderBy({"id" = "ASC"})
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="TestApp\Entity\IgnoreOriginUserRule", mappedBy="config", cascade={"remove"})
     * @ORM\OrderBy({"id" = "ASC"})
     */

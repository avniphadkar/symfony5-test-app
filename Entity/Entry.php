...
use TestApp\Helper\UrlHasher;

/**
 * Entry.
 *
 * @XmlRoot("entry")
 * @ORM\Entity(repositoryClass="TestApp\Repository\EntryRepository")
 * @ORM\Table(
 *     name="`entry`",
 *     indexes={
...
class Entry
{
    ...
    /**
     * Define the url fetched by testapp (the final url after potential redirections).
     *
     * @var string|null
     *
     * @Assert\NotBlank()
    ...
    /**
     * @ORM\OneToMany(targetEntity="TestApp\Entity\Annotation", mappedBy="entry", cascade={"persist", "remove"})
     * @ORM\JoinTable
     *
     * @Groups({"entries_for_user", "export_all"})
     */
     ...
     * @Exclude
     *
     * @ORM\ManyToOne(targetEntity="TestApp\Entity\User", inversedBy="entries")
     *
     * @Groups({"export_all"})
     */
    private $user;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="TestApp\Entity\Tag", inversedBy="entries", cascade={"persist"})
     * @ORM\JoinTable(
     *  name="entry_tag",
     *  joinColumns={

...
class EntryRepository extends ServiceEntityRepository
{
    ...
    public function removeAllByUserId($userId)
    {
        $this->getEntityManager()
            ->createQuery('DELETE FROM TestApp\Entity\Entry e WHERE e.user = :userId')
    ...
    {
        $this->getEntityManager()
            ->createQuery('DELETE FROM TestApp\Entity\Entry e WHERE e.user = :userId AND e.isArchived = TRUE')
            ->setParameter('userId', $userId)
            ->execute();
    }
